...
const ShiftingCountdown = () => {
  ...
  return (
    <div className="p-4 flex flex-col gap-3 bg-gradient-to-br from-violet-600 to-indigo-600">
      <h1 className="text-4xl font-bold text-white text-center">We're Going Live Soon!</h1>
      <div className="w-full max-w-5xl mx-auto flex items-center bg-white rounded-lg">
